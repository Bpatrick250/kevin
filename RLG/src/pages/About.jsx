...
import {
  faEye, faBullhorn, faHeart, faTarget, faFlag, faHandshake,
  faBuilding, faUsers, faCalendarAlt, faArrowRight, faQuoteLeft,
  faCheckCircle, faStar, faTrophy, faGlobe, faSchool, faUniversity,
  faHandsHelping, faLightbulb, faChartLine, faRocket, faUserTie,
  faBriefcase, faPeopleArrows, faNetworkWired, faClipboardList,
  faTasks, faComments, faEnvelope, faPhone, faMapMarkerAlt,
  faAward, faCrown, faLeaf, faGem, faCompass, faDove, faFire,
  faSmile, faHandSpock, faMedal, faShieldHeart, faHandHoldingHeart
...
const leadershipTeam = [
  ...
  { name: "Community Coordinators", role: "Grassroots Connection", icon: faPeopleArrows, description: "Connect youth and grassroots leaders to programs" },
];
  ...
  return (
    <div className="rlg-about-page pt-16">
      <style>{`
        ...
        .rlg-goal-card h3 { font-weight: 700; margin-bottom: .5rem; color: #14532d; }
        ...
        .rlg-outlook h2 { font-family: 'Playfair Display', serif; font-size: clamp(1.8rem, 3vw, 2.5rem); margin-bottom: 1rem; }
      ...
      <section className="rlg-goals">
        <div className="rlg-container">
          <div style={{ textAlign: "center" }}>
            <div className="rlg-label"><FontAwesomeIcon icon={faTarget} /> Our Goals</div>
          ...
          <div className="rlg-goals-grid">
            <div className="rlg-goal-card fade-up">
              <FontAwesomeIcon icon={faTrophy} />
              <div>
                <h3>Influencing Generational Competence</h3>
                <p>Values with account to visionary and transforming leadership.</p>
              </div>
            </div>
            <div className="rlg-goal-card fade-up-1">
              <FontAwesomeIcon icon={faBrain} />
              <div>
                <h3>Mental Transformation</h3>
                <p>Heritage and welfare for sustainable development.</p>
              </div>
            </div>
            <div className="rlg-goal-card fade-up-2">
              <FontAwesomeIcon icon={faChartLine} />
              <div>
                <h3>Social & Economic Prosperity</h3>
                <p>Empowerment by advancing understanding about mental, social and economic prosperity.</p>
              </div>
            </div>
            <div className="rlg-goal-card fade-up-3">
              <FontAwesomeIcon icon={faHandshake} />
              <div>
                <h3>Building Strong Communities</h3>
                <p>Societies with strong relationships, trustworthy and togetherness.</p>
              </div>
            </div>
            <div className="rlg-goal-card fade-up-1">
              ...
              <div>
                ...
                <p>Building partnerships with schools, universities, NGOs, and private sector organizations.</p>
              </div>
            </div>
          </div>
        </div>
